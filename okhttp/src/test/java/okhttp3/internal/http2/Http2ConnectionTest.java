...
public final class Http2ConnectionTest {
	 ...
	 */
	@Test
	public void serverResponseBodyRstStream() throws Exception {
		// write the mocking script
		peer.sendFrame().settings(new Settings());
		peer.acceptFrame(); // ACK
		peer.acceptFrame(); // SYN_STREAM
	 ...
	 */
	@Test
	public void serverTrailersRstStream() throws Exception {
		// write the mocking script
		peer.sendFrame().settings(new Settings());
		peer.acceptFrame(); // ACK
		peer.acceptFrame(); // SYN_STREAM
	 ...
	 */
	@Test
	public void clientRequestBodyServerResponseBodyRstStream() throws Exception {
		// write the mocking script
		peer.sendFrame().settings(new Settings());
		peer.acceptFrame(); // ACK
		peer.acceptFrame(); // SYN_STREAM
	...
	@Test
	public void connectionUsesTaskRunner() throws Exception {
		peer.acceptFrame(); // SYN_STREAM.
		peer.play();
