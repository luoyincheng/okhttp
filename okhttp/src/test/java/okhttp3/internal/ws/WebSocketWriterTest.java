...
public final class WebSocketWriterTest {
	 ...
	 */
	@RegisterExtension
	public final AfterEachCallback noDataLeftBehind = context -> {
	...
	@Test
	public void serverCompressedTextMessage() throws IOException {
	...
	@Test
	public void clientCompressedTextMessage() throws IOException {
