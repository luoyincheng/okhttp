...
public final class WebSocketReaderTest {
	...
	@Test
	public void reservedFlag1IsUnsupportedWithNoCompression() throws IOException {
	...
	@Test
	public void reservedFlag1IsUnsupportedForControlFrames() throws IOException {
		data.write(ByteString.decodeHex("ca00")); // Empty pong, flag 1 set.
		try {
	...
	@Test
	public void reservedFlag1IsUnsupportedForContinuationFrames() throws IOException {
	...
	@Test
	public void reservedFlags2and3AreUnsupported() throws IOException {
	...
	@Test
	public void clientWithCompressionSimpleUncompressedHello() throws IOException {
		data.write(ByteString.decodeHex("810548656c6c6f")); // Hello
		clientReaderWithCompression.processNextFrame();
		callback.assertTextMessage("Hello");
	}
	...
	@Test
	public void clientWithCompressionSimpleCompressedHello() throws IOException {
	...
	@Test
	public void serverWithCompressionSimpleUncompressedHello() throws IOException {
		data.write(ByteString.decodeHex("818537fa213d7f9f4d5158")); // Hello
	...
	@Test
	public void serverWithCompressionSimpleCompressedHello() throws IOException {
	...
	@Test
	public void serverWithCompressionHelloTwoChunks() throws IOException {
		data.write(ByteString.decodeHex("818537fa213d7f9f4d")); // Hel
		data.write(ByteString.decodeHex("5158")); // lo
	...
	@Test
	public void serverWithCompressionCompressedHelloTwoChunks() throws IOException {
	...
	@Test
	public void clientWithCompressionTwoFrameHello() throws IOException {
		data.write(ByteString.decodeHex("010348656c")); // Hel
		data.write(ByteString.decodeHex("80026c6f")); // lo
		clientReaderWithCompression.processNextFrame();
		callback.assertTextMessage("Hello");
	...
	@Test
	public void clientWithCompressionTwoFrameCompressedHello() throws IOException {
	...
	@Test
	public void clientTwoFrameCompressedHelloWithPongs() throws IOException {
		data.write(ByteString.decodeHex("4104f248cdc9")); // first 4 bytes of compressed 'Hello'
		data.write(ByteString.decodeHex("8a00")); // Pong
		data.write(ByteString.decodeHex("8a00")); // Pong
		data.write(ByteString.decodeHex("8a00")); // Pong
	...
	@Test
	public void clientUncompressedMessageWithCompressedFlagThrows() throws IOException {
	...
	@Test
	public void clientWithCompressionCannotBeUsedAfterClose() throws IOException {
		data.write(ByteString.decodeHex("c107f248cdc9c90700")); // Hello
		clientReaderWithCompression.processNextFrame();
		callback.assertTextMessage("Hello");
