...
public final class HostnameVerifierTest {
	...
	@Test
	public void subjectAltNameWithIPAddresses() throws Exception {
		// $ cat ./cert.cnf
		// [req]
		// distinguished_name=distinguished_name
		// req_extensions=req_extensions
	...
	@Test
	public void generatedCertificate() throws Exception {
	...
	@Test
	public void specialKInHostname() throws Exception {
	...
	@Test
	public void specialKInCert() throws Exception {
		// https://github.com/apache/httpcomponents-client/commit/303e435d7949652ea77a6c50df1c548682476b6e
		// https://www.gosecure.net/blog/2020/10/27/weakness-in-java-tls-host-verification/
	...
	@Test
	public void specialKInExternalCert() throws Exception {
	...
	@Test
	public void replacementCharacter() throws Exception {
		// $ cat ./cert.cnf
		// [req]
		// distinguished_name=distinguished_name
		// req_extensions=req_extensions
