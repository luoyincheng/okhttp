...
public final class ConnectionCoalescingTest {
	...
	@Test
	public void skipsOnRedirectWhenDnsDontMatch() throws Exception {
		server.enqueue(new MockResponse()
			.setResponseCode(301)
	...
	@Test
	public void skipsOnRedirectWhenNotSubjectAltName() throws Exception {
		server.enqueue(new MockResponse()
			.setResponseCode(301)
	...
	@Test
	public void skipsOnRedirectWhenHostnameVerifierUsed() throws Exception {
		HostnameVerifier verifier = (name, session) -> true;
		client = client.newBuilder().hostnameVerifier(verifier).build();
	...
	@Test
	public void misdirectedRequestResponseCode() throws Exception {
		server.enqueue(new MockResponse()
	 ...
	 */
	@Test
	public void redirectWithDevSetup() throws Exception {
