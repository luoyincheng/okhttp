...
public final class EventListenerTest {
	...
	@Test
	public void cancelAsyncCall() throws IOException {
		server.enqueue(new MockResponse()
			.setBody("abc"));
	...
	@Test
	public void multipleCancelsEmitsOnlyOneEvent() throws IOException {
		server.enqueue(new MockResponse()
			.setBody("abc"));
	...
	@Test
	public void requestBodyFailHttp1OverHttps() {
		enableTlsWithTunnel(false);
		server.setProtocols(asList(Protocol.HTTP_1_1));
	...
	@Test
	public void requestBodyFailHttp2OverHttps() {
		platform.assumeHttp2Support();
	...
	@Test
	public void requestBodyFailHttp() {
	...
	@Test
	public void satisfactionFailure() throws IOException {
		enableCache();
