...
public final class ServerSentEventIteratorTest {
	...
	@Test
	public void multilineCr() throws IOException {
		consumeEvents(""
			+ "data: YHOO\r"
			+ "data: +2\r"
			+ "data: 10\r"
	...
	@Test
	public void multilineCrLf() throws IOException {
		consumeEvents(""
			+ "data: YHOO\r\n"
			+ "data: +2\r\n"
			+ "data: 10\r\n"
	...
	@Test
	public void eventType() throws IOException {
		consumeEvents(""
			+ "event: add\n"
			+ "data: 73857293\n"
			+ "\n"
	...
	@Test
	public void commentsIgnored() throws IOException {
		consumeEvents(""
			+ ": test stream\n"
			+ "\n"
			+ "data: first event\n"
	...
	@Test
	public void idCleared() throws IOException {
		consumeEvents(""
			+ "data: first event\n"
			+ "id: 1\n"
			+ "\n"
	...
	@Test
	public void nakedFieldNames() throws IOException {
		consumeEvents(""
			+ "data\n"
			+ "\n"
			+ "data\n"
	...
	@Test
	public void colonSpaceOptional() throws IOException {
		consumeEvents(""
			+ "data:test\n"
			+ "\n"
			+ "data: test\n"
	...
	@Test
	public void idReusedAcrossEvents() throws IOException {
		consumeEvents(""
			+ "data: first event\n"
			+ "id: 1\n"
			+ "\n"
	...
	@Test
	public void idIgnoredFromEmptyEvent() throws IOException {
		consumeEvents(""
			+ "data: first event\n"
			+ "id: 1\n"
			+ "\n"
	...
	@Test
	public void retryInvalidFormatIgnored() throws IOException {
		consumeEvents(""
			+ "retry: 22\n"
			+ "\n"
			+ "retry: hey"
	...
	@Test
	public void namePrefixIgnored() throws IOException {
		consumeEvents(""
			+ "data: a\n"
			+ "eventually\n"
			+ "database\n"
	...
	@Test
	public void nakedNameClearsIdAndTypeAppendsData() throws IOException {
		consumeEvents(""
			+ "id: a\n"
			+ "event: b\n"
			+ "data: c\n"
	...
	@Test
	public void nakedRetryIgnored() throws IOException {
		consumeEvents(""
			+ "retry\n"
			+ "\n");
		assertThat(callbacks).isEmpty();
